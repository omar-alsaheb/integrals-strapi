...
export interface ApiContactInformationContactInformation
  ...
  attributes: {
    information: Attribute.Text & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiWhoWeAreCardWhoWeAreCard extends Schema.CollectionType {
  collectionName: 'who_we_are_cards';
  info: {
    singularName: 'who-we-are-card';
    pluralName: 'who-we-are-cards';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::who-we-are-card.who-we-are-card',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::who-we-are-card.who-we-are-card': ApiWhoWeAreCardWhoWeAreCard;
    }
  }
}
